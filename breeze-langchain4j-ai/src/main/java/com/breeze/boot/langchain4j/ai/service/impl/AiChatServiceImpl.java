...
import com.breeze.boot.langchain4j.ai.assistant.Assistant;
...
public class AiChatServiceImpl implements IAiChatService {
    ...
    public AiChatServiceImpl(MongoDBChatMessageRepository mongoDBChatConversationRepository, Assistant assistant,
                             AiModelServiceImpl aiModelService,
                             AiPlatformService aiPlatformService
    ) {
        this.mongoDBChatMessageRepository = mongoDBChatConversationRepository;
    ...
    public Flux<String> chat(String model, String platform, String message, Long conversationId) {
        ...
        Flux<String> chat = assistant.chat(conversationId, message);
        // 启动流式响应并附加完成标记
