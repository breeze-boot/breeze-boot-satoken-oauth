...
import com.breeze.boot.modules.ai.mapper.ChatLLMMapper;
...
public class ChatLLMServiceImpl extends ServiceImpl<ChatLLMMapper, ChatLLM> implements IChatLLMService {
    ...
    @Override
    public Object modifyChatLLM(Long id, ChatLLM chatLLM) {
        return null;
    }
