...
public class SysUserServiceImpl extends ServiceImpl<SysUserMapper, SysUser> implements SysUserService {
    ...
    public Result<Boolean> saveUser(UserForm form) {
        AssertUtil.isNotNull(this.sysDeptService.getById(form.getDeptId()), ResultCode.DEPT_NOT_FOUND);
    ...
    private boolean saveUserRole(UserForm userForm, Long id) {
        ...
        if (saveBatch) {
            @SuppressWarnings("unchecked") List<String> userRoleCodeList = (List<String>) SaManager.getSaTokenDao().getObject(CacheConstants.ROLE_PERMISSION + id);
            if (userRoleCodeList != null) {
                ...
                SaManager.getSaTokenDao().updateObject(CacheConstants.ROLE_PERMISSION + id, userRoleCodeList);
            }
        }
        return saveBatch;
    }
    ...
    public Result<Boolean> removeUser(List<Long> ids) {
        ...
        AssertUtil.isTrue(CollUtil.isNotEmpty(sysUserList), ResultCode.NOT_FOUND);
    ...
    public SysUser registerUser(SysUser registerUser, String roleCode) {
        ...
        AssertUtil.isNotNull(sysRole, ResultCode.ROLE_NOT_FOUND);
