...
public class SysRoleServiceImpl extends ServiceImpl<SysRoleMapper, SysRole> implements SysRoleService {
    ...
    public Result<Boolean> deleteByIds(List<Long> ids) {
        ...
        AssertUtil.isTrue(CollUtil.isNotEmpty(roleList), ResultCode.ROLE_NOT_FOUND);
        ...
        if (remove) {
            ...
            for (SysRole sysRole : roleList) {
                @SuppressWarnings("unchecked") List<String> permissionList = (List<String>) SaManager.getSaTokenDao().getObject(CacheConstants.PERMISSIONS + sysRole.getRoleCode());
                if (permissionList != null) {
                    SaManager.getSaTokenDao().delete(CacheConstants.PERMISSIONS + sysRole.getRoleCode());
                }
            }
        }
    ...
    public Result<Boolean> modifyMenuPermission(MenuPermissionForm form) {
        ...
        if (batch) {
            ...
            if (permissionList != null) {
                ...
                SaManager.getSaTokenDao().updateObject(CacheConstants.PERMISSIONS + sysRole.getRoleCode(), permissionList);
            }
        }
